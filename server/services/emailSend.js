...
const updateSendMail = async (name, email, ticketId, data) => {
  console.log("@@@@@@@@@@@@@@@@@@@@@@", data)
  // Generate test SMTP service account from ethereal.email
  // Only needed if you don't have a real mail account for testing
  let testAccount = await nodemailer.createTestAccount();
  ...
  let info = await transporter.sendMail({
    ...
    from: "bkdeora1699@mail.com", // sender address
    to: email, // list of receivers
    subject: "Update Ticket Information ", // Subject line
    text: "Your Ticket" + ticketId + "is Updated By Admin.", // plain text body
    html: `
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    <title>
                  ...
                  <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='vertical-align:top;' width='100%'>
                    <tr>
                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                        <div style='color:#30373b;font-family:Open Sans, Arial, sans-serif;font-size:15px;font-weight:bold;line-height:18px;text-align:center;'>
                        Hey ${name},<br>
                        Your Ticket(#${ticketId}) Details Are Update.
                        ${data}
...
module.exports = { sendMail, updateSendMail };
